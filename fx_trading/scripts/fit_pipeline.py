...
class FeaturePipeline:
    ...
    def _compute_features(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        # ---- Session features ----
        # FIX: single definition of session boundaries — second duplicate block removed.
        # Using NY open at 12:00 UTC (consistent with London/NY overlap at 12-16 UTC).
...
def _rolling_zscore(series: pd.Series, window: int) -> pd.Series:
    ...
    Division by zero (flat series) returns NaN.
    """
